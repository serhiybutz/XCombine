...
final class ShareReplayLogicWithSequencesWithCapacityOf2: XCTestCase {
    let capacity = 2
    ...
    func test_twoElementsWith2Subscribers() {
        ...
        // - Then
        expected2 = [.value(1), .value(2), .completion(.finished)]
        XCTAssert(
            results2 == expected2,
            "Results expected to be \(expected2) but were \(results2)"
        )
    ...
    func test_twoElementsWith3Subscribers() {
        ...
        // - Then
        expected3 = [.value(1), .value(2), .completion(.finished)]
        XCTAssert(
            results3 == expected3,
    ...
    func test_threeElementsWith2Subscribers() {
        // Given

        let publisher = [1, 2, 3].publisher.x.share(replay: capacity)
        ...
        expected1 = [.value(1), .value(2), .value(3), .completion(.finished)]
        XCTAssert(
            results1 == expected1,
            "Results expected to be \(expected1) but were \(results1)"
        )
        ...
        // - Then
        expected2 = [.value(2), .value(3), .completion(.finished)]
        XCTAssert(
            results2 == expected2,
            "Results expected to be \(expected2) but were \(results2)"
        )
